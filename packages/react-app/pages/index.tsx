...
export default function Home() {
    ...
    const [contractDeploymentLoading, setContractDeploymentLoading] = useState(false);
    ...
    async function callDeployContract() {
        setContractDeploymentLoading(true);
        try {
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            {address && (
                <>
                    ...
                    <div className="w-full px-3 mt-5">
                        <PrimaryButton
                            loading={contractDeploymentLoading}
                            onClick={callDeployContract}
                            title="Deploy Aion Contract"
                            widthFull
                        />
                    </div>
                </>
